angular.module('friut',[])
.config(function($stateProvider){
	$stateProvider
	.state('friut',{
		url:'/friut',
		controller:'ctrl77',
		templateUrl:'app/view/home/friut/friut.html'
	})
})
.controller('ctrl77',function($scope,$http){
	$http.get('http://localhost:8888/app/view/home/data/friut.json')
	.then(function(res){
		console.log(res);
		return res.data
	})
