angular.module('flowerCake',[])
.config(function($stateProvider){
	$stateProvider
	.state('flowerCake',{
		url:'/flowerCake',
		controller:'ctrl76',
		templateUrl:'app/view/home/flowerCake/flowerCake.html'
	})
})
.controller('ctrl76',function($scope,$http){
	$http.get("http://localhost:8888/app/view/home/data/flowerCake.json")
	.then(function(res){
		return res.data;
	})
	.then(function(res){
