...
.config(function($stateProvider){
	...
	.state('psym',{
		url:'/psym',
		controller:'ctrldd',
		templateUrl:'app/view/home/psym/psym.html'
	})
})
.controller('ctrldd',['$scope','$http',function($scope,$http){

    $http.get('http://localhost:8888/app/view/home/data/2.json')
    .then(function(res){
      return res.data;
        console.log(res);
    })
