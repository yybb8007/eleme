angular.module('hamburger',[])
.config(function($stateProvider){
	$stateProvider
	.state('hamburger',{
		url:'/hamburger',
		controller:'ctrl66',
		templateUrl:'app/view/home/hamburger/hamburger.html'
	})
})
.controller('ctrl66',function($scope,$http){
	$http.get("http://localhost:8888/app/view/home/data/hamburger.json")
	.then(function(res){
		return res.data;
	})
	.then(function(res){
